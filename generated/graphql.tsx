...
export type GetRepositoryQuery = (
  ...
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & Pick<Repository, 'forkCount' | 'viewerDefaultCommitEmail' | 'mergeCommitAllowed' | 'pushedAt'>
    & { pullRequest?: Maybe<(
      { __typename?: 'PullRequest' }
      & Pick<PullRequest, 'id'>
    )>, commitComments: (
      ...
      & { pageInfo: (
        ...
        { __typename?: 'CommitComment' }
        & Pick<CommitComment, 'body'>
        & { commit?: Maybe<(
          { __typename?: 'Commit' }
          & Pick<Commit, 'commitResourcePath' | 'committedDate'>
          & { author?: Maybe<(
            { __typename?: 'GitActor' }
            & Pick<GitActor, 'email'>
          )>, committer?: Maybe<(
            { __typename?: 'GitActor' }
            & Pick<GitActor, 'email' | 'name'>
          )> }
        )> }
      )>>> }
    ) }
...
export type Unnamed_1_Query = (
  ...
  & { repositoryOwner?: Maybe<(
    { __typename?: 'Organization' }
    & Pick<Organization, 'avatarUrl' | 'id' | 'login'>
  ) | (
    { __typename?: 'User' }
    & Pick<User, 'avatarUrl' | 'id' | 'login'>
  )> }
);
